...
Let’s wander around a bit. Before that download the zip file with the materials of the course: [https://univie-tnt-2019-fall.github.io/files/tnt_practice_materials.zip](https://univie-tnt-2019-fall.github.io/files/tnt_practice_materials.zip). Unzip it somewhere and go to that folder in your `Terminal` or `Powershell`.
